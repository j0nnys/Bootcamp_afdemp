...
namespace Exercise_Fraction
{
    class Program
    {
        class Fraction : IComparable<Fraction>
        {
            ...
            // Property decimal has only getter. We don't want to be ableto assign a value
            ...
            // Create a Fraction froom string
            public static Fraction Parse(string str)
            {
                ...
                int num;
                if (!Int32.TryParse(split[0], out num)) // to (!) σημαινει == false
                {
                    // throw new ArithmeticException;
                }
                int den;
